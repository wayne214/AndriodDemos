...
public class RecyclerviwActivity extends AppCompatActivity implements MyAdapter.OnItemClickListener, OnRefreshListener, OnLoadMoreListener {

    private final String TAG = "RecyclerviwActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recyclerviw);
    ...
    public void onItemClick(View view, int position) {
        Toast.makeText(RecyclerviwActivity.this,"Click:"+position, Toast.LENGTH_SHORT).show();
    }
